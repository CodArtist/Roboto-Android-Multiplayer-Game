...
namespace EZCameraShake
{
    ...
    public class CameraShaker2 : MonoBehaviour
    {
        /// <summary>
        /// The single instance of the CameraShaker in the current scene. Do not use if you have multiple instances.
        /// </summary>
        public static CameraShaker2 Instance;
        static Dictionary<string, CameraShaker2> instanceList = new Dictionary<string, CameraShaker2>();
        ...
        /// <returns></returns>
        public static CameraShaker2 GetInstance(string name)
        {
            CameraShaker2 c;
