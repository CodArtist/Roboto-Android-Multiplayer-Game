...
namespace EZCameraShake
{
    ...
    public class CameraShaker1 : MonoBehaviour
    {
        ...
        /// </summary>
        public static CameraShaker1 Instance;
        static Dictionary<string, CameraShaker1> instanceList = new Dictionary<string, CameraShaker1>();
        ...
        /// <returns></returns>
        public static CameraShaker1 GetInstance(string name)
        {
            CameraShaker1 c;
