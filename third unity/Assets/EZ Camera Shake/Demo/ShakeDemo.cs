...
public class ShakeDemo : MonoBehaviour 
{
	...
	void OnGUI()
    {
        ...
        {
            shake = CameraShaker1.Instance.StartShake(magn, rough, fadeIn);
        ...
        {
            CameraShakeInstance c = CameraShaker1.Instance.ShakeOnce(magn, rough, fadeIn, fadeOut);
        ...
        if (!showList)
            ...
            height = 120 + CameraShaker1.Instance.ShakeInstances.Count * 130f;
        ...
        {
            int index = 1;
            foreach (CameraShakeInstance c in CameraShaker1.Instance.ShakeInstances)
            {
